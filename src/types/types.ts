...
export const VerificationSchema = z.object({
  code: z
    .string({ message: "کد تایید را وارد کنید " })
...
export const UserInfoSchema = z.object({
  ...
  birthday: z
    .string({ message: "تاریخ تولد نمی‌تواند خالی باشد" })
    .min(1, { message: "تاریخ تولد نمی‌تواند خالی باشد" }),
  national_code: z
    .string({ message: "کد ملی نمی‌تواند خالی باشد" })
  ...
  address: z
    ...
    .min(1, { message: "آدرس نمی‌تواند خالی باشد" }),
  postal_code: z
    .string({ message: "کد پستی نمی‌تواند خالی باشد" })
    .min(1, { message: "کد پستی نمی‌تواند خالی باشد" }),
});
